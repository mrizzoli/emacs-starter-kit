...
#+begin_src emacs-lisp 
  ...
  (setq helm-bibtex-bibliography '("/home/mrizzoli/notes_src/biblio/biblio.bib"))
  ;;(helm-delete-action-from-source "Insert reference" helm-source-bibtex)
  ;;(helm-add-action-to-source "Insert reference" 'helm-bibtex-insert-key helm-source-bibtex 0)
  (global-set-key (kbd "C-c c") 'helm-bibtex)

  ;;Geeknote
  (autoload 'geeknote "geeknote.el" "" t)
